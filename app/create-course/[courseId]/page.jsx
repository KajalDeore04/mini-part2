...
const ChapterEditor = () => {
  ...
  const saveChanges = async () => {
    try {
      ...
      updatedCourse.courseOutput.chapters = tempChapters;
      updatedCourse.courseOutput.noOfChapters = tempChapters.length;
      ...
      showNotification(
        'success',
        'Changes saved',
        'Your course chapters have been updated successfully'
      );
    } catch (error) {
  ...
  const generateContent = async () => {
    try {
      ...
      showNotification(
        'error',
        'Generation failed',
        'There was a problem generating your course content. Please try again later.'
      );
    } finally {
      setLoading(false);
    }
